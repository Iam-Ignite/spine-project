           ...
           <!-- PAGE CONTENT --> */}
			<main className='flex-1  bg-[#FBFCFD] pb-44 h-screen lg:overflow-x-hidden md:overflow-x-hidden py-16 overflow-y-scroll'>
				...
				<div className='flex flex-col md:flex-row lg:flex-row mx-5 md:mx-0 justify-between items-center '>
					<ChartDetailBox />
					<div className='mt-10 md:mr-16 lg:mr-16 overflow-y-auto md:w-full lg:w-full w-full  h-80 py-7 border bg-slate-100 px-7'>
						...
						<div className='overflow-y-auto'>
							<div className='flex w-full fonts justify-between items-end bg-white p-4 rounded-sm m-2'>
							...
							<div className='flex w-full justify-between items-end bg-white p-4 rounded-sm m-2'>
								<p className='text-sm fonts'>
									5 Transactions are pending review
								</p>
								<label
